      ...
      <b-card-body>
        ...
        <b-form-group>
          ...
          <div
            ...
            "
          >
            <label for="cvv" class="text-nowrap mr-1 mb-1"> Enter CVV: </label>
            <b-form-input
              id="cvv"
              ...
              trim
            />
            <b-button variant="primary" class="mb-1"> Continue </b-button>
          </div>

          <hr class="mb-2 mt-1" />

          <b-form-radio name="payment-method" value="debit-atm-credit-card">
            Credit / Debit / ATM Card
          </b-form-radio>
          <b-form-radio name="payment-method" class="mt-1" value="net-banking">
            Net Banking
          </b-form-radio>
          <b-form-radio name="payment-method" class="mt-1" value="emi">
            EMI (Easy Installment)
          </b-form-radio>
          <b-form-radio name="payment-method" class="mt-1" value="cod">
            Cash On Delivery
          </b-form-radio>
        </b-form-group>
